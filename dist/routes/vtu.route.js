...
const vtu_controller_2 = require("../controllers/vtu.controller");
...
router.get('/data', vtu_controller_2.GetDataPlans);
router.get('/all_transactions', auth_1.default, vtu_controller_1.GetAllTransactions);
router.get('/data-plans', vtu_controller_2.GetDataPlans); // New endpoint for GetDataPlans
